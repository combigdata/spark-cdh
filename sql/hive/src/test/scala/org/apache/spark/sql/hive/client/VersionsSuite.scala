...
class VersionsSuite extends SparkFunSuite with Logging {
  ...
  private val execJars: Seq[URL] = sys.props("java.class.path")
    .split(File.pathSeparator).map { p => new File(p).toURL() }
  ...
  // private val versions = Seq("0.12", "0.13", "0.14", "1.0", "1.1", "1.2", "2.0", "2.1", "2.2", "2.3")
